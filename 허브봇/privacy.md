...
## 제 1조. 개인정보의 처리 목적
허브봇은 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.
> 서비스 제공 및 유지
...
① 허브봇은 다음의 개인정보 항목을 처리하고 있습니다.
> 필수항목 : 없음
> 
> 선택항목
> + 경제 시스템 이용시 : 디스코드 ID
> + 백업 시스템 이용시 : 서버 채널(텍스트, 음성, 카테고리), 서버 설정값, 서버 역할값, 서버 밴목록, 채널 권한, 서버 주인의 디스코드 ID
> + 뮤트 시스템 이용시 : 뮤트유저및 뮤트한 관리자의 디스코드 ID, 뮤트유저의 보유 역할 데이터

## 제 5조. 개인정보 보호책임자 작성
① 허브봇는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
...
허브봇은 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.

**1. 정기적인 자체 감사 실시**
> 개인정보 취급 관련 안정성 확보를 위해 정기적(분기 1회)으로 자체 감사를 실시하고 있습니다.

**2. 해킹 등에 대비한 기술적 대책**
> 허브봇은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.
...
아래의 기관은 삼해트의 공방과 별개의 기관으로서, 허브봇은 자체적인 개인정보 불만처리, 피해구제 결과에 만족하지 못하시거나 보다 자세한 도움이 필요하시면 문의하여 주시기 바랍니다.
...
## 제 9조. 개인정보 처리방침 변경
① 이 개인정보처리방침은 2022년 02월 09일부터 적용됩니다.
